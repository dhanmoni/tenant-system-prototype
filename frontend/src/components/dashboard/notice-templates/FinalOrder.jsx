export default function FinalOrder({ data }) {
    return (
        <>
            ...
            <p style={{ marginBottom: '1rem' }}>An application concerning a tenancy dispute in respect of the premises situated at {data.propertyAddress} was filed before the {data.officeName} through the Assam Tenancy Portal under the Assam Tenancy Act, 2021 and the Rules made thereunder.</p>
            ...
            <p style={{ marginBottom: '1rem' }}>Both parties appeared before the {data.officeName} and were given a reasonable opportunity to be heard.</p>
            ...
            <p style={{ marginBottom: '1rem' }}>On consideration of the submissions and the terms placed on record, the {data.officeName} finds that the settlement was entered into voluntarily and, on the face of the record, is not contrary to law.</p>
