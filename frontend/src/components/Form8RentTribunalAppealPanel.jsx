		...
		<div className="dashboard-card service-form-panel">
			...
			<form className="tenancy-form" onSubmit={requestPreview}>
				<ServiceFormSection
					icon={IdCard}
					title="Tenancy"
					lead="Start with the UIN for this tenancy, then name the Rent Tribunal where this appeal is filed."
				>
					<TenancyUinLookup
						value={tenancyUIN}
					...
					<label>
						<ServiceFormFieldLabel
							required
							hint="Name the place of the Rent Tribunal hearing this appeal."
							info="Form VI — Before the Rent Tribunal at."
						>
						...
						<div className="sf-party-card">
							...
							<label>
								<ServiceFormFieldLabel
									...
									info="Add description and the residential address on which the service of notices is to be effected on the Respondent(s)."
								>
				...
				<ServiceFormSection
					...
					lead="Explain the appeal in plain words. Paragraph numbers match Form VI in the Gazette."
				>
					<label className="tenancy-field-full">
						<ServiceFormFieldLabel
							required
							...
							info="Form VI para 1 — Particulars of the order of the Rent Court as against which the Appeal is made."
						>
							Particulars of the order of the Rent Court as against which the Appeal is made
						</ServiceFormFieldLabel>
						<textarea
							required
					...
					<div className="sf-field-block">
						<ServiceFormFieldLabel
							required
							para={2}
							hint="Confirm that this Rent Tribunal is the correct place to file this appeal."
							info="Form VI para 2 — Jurisdiction of the Rent Tribunal (declaration)."
						>
						...
						<DeclarationCheckbox
							...
							hideLabel
							simple
							summary="Yes — this appeal can be heard by this Rent Tribunal"
					...
					<div className="sf-field-block">
						<ServiceFormFieldLabel
							...
							info="Form VI para 3 — Limitation (declaration)."
						>
							Limitation
						</ServiceFormFieldLabel>
						<DeclarationCheckbox
					...
					<label className="tenancy-field-full">
						<ServiceFormFieldLabel
							...
							info="Form VI para 4 — Memorandum of Appeal. Grounds for appeal with legal provisions."
						>
					...
					<div className="sf-field-block">
						<ServiceFormFieldLabel
							...
							info="Form VI para 5 — Matters not previously filed or pending with any other court."
						>
					...
					<label className="tenancy-field-full">
						<ServiceFormFieldLabel
							...
							info="Form VI para 6 — Relief sought."
						>
							Relief sought
						</ServiceFormFieldLabel>
						<textarea
					...
					<label className="tenancy-field-full">
						<ServiceFormFieldLabel
							...
							info="Form VI para 7 — Interim order, if any prayed for."
						>
					...
					<label className="tenancy-field-full">
						<ServiceFormFieldLabel
							required
							para={8}
							hint="Must include a certified copy of the Rent Court order appealed against (Rule 13(3))."
							info="Form VI para 8 — List of enclosures. Rule 13(3) requires the Memorandum to be accompanied by the certified copy of the order of the Rent Court appealed against."
						>
							List of enclosures
						</ServiceFormFieldLabel>
						<textarea
