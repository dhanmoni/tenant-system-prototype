...
const PAGE_KEYWORDS = {
	...
	'ws.nav.applicationInbox': ['inbox', 'applications', 'review', 'queue'],
	'ws.nav.applications': ['applications', 'inbox', 'tenancy', 'service'],
	'ws.nav.users': ['users', 'staff', 'directory'],
	'ws.nav.districtsGroup': ['districts', 'locations', 'map', 'admin'],
