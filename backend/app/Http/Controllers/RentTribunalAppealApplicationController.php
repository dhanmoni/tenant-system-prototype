...
class RentTribunalAppealApplicationController extends Controller
{
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'list_of_enclosures' => ['required', 'string'],
            ...
            ...Verification::rules(Declarations::FORM_VI_VERIFICATION),
        ...
        if (Verification::personalKnowledgeIsEmpty(Declarations::FORM_VI_VERIFICATION, $data)) {
        ...
        $verification = Verification::normalise(Declarations::FORM_VI_VERIFICATION, $data);

        $signaturePath = null;
        if ($request->hasFile('signature_image')) {
            $signaturePath = DocumentStore::store($request->file('signature_image'), 'tenancy/signatures/rent-tribunal-appeal');
        }
        ...
        $application = RentTribunalAppealApplication::create([
            ...
            'jurisdiction_of_rent_tribunal' => Declarations::textFor(Declarations::FORM_VI_JURISDICTION),
            ...
            'limitation' => Declarations::textFor(Declarations::FORM_VI_LIMITATION),
            'memorandum_of_appeal' => $data['memorandum_of_appeal'] ?? null,
            'matters_not_previously_filed_or_pending' => PriorProceedings::summarise(
                $priorProceedings,
                Declarations::textFor(Declarations::FORM_VI_PRIOR_PROCEEDINGS)
            ),
